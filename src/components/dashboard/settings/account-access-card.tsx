  ...
  return (
    <SettingsCard>
      ...
      <div className="mt-5 flex items-center gap-5">
        <div className="flex h-[62px] w-[62px] shrink-0 items-center justify-center rounded-[1.2rem] bg-[color:var(--dash-brand)] text-[1.55rem] font-black text-white shadow-[0_16px_32px_rgba(201,107,72,0.24)]">
          {account.initials}
        </div>
        <div className="min-w-0 flex-1">
          <p className="truncate text-[1.35rem] font-black tracking-[-0.02em] text-[color:var(--dash-foreground)]">
            {account.name ?? "Not available"}
          </p>
          <p className="mt-1 truncate text-sm font-semibold text-[#b09887]">
...
function DetailRow({
  ...
  return (
    <div className="flex items-center gap-5 border-t border-[#eee5db] py-6 first:border-t-0">
      <div
        className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#fbf3ea] text-[color:var(--dash-brand)]"
        aria-hidden="true"
      >
      ...
      <div className="min-w-0 flex-1">
        ...
        <p className="mt-1 truncate text-base font-black text-[color:var(--dash-foreground)]">{value}</p>
      </div>
      {badge}
    </div>
  );
