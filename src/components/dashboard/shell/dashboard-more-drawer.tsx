...
import { Activity, ChevronRight, CreditCard, FileText, Globe, LogOut, Settings2 } from "lucide-react";
          ...
          {remainingItems.map((item) => {
            ...
            return (
              ...
              >
                ...
                />
                <span className={active ? "min-w-0 flex-1 truncate text-sm text-[--dash-brand]" : "min-w-0 flex-1 truncate text-sm text-[--dash-foreground]"}>
                  {item.label}
                </span>
