...
> = {
  ...
  baptism: {
    optionalDefaults: [
      ...
      { defaultEnabled: false, key: "godparents" },
      { defaultEnabled: false, key: "timeline_program" },
      { defaultEnabled: false, key: "attire_motif" },
      { defaultEnabled: false, key: "gallery" },
      { key: "guestbook" },
      { defaultEnabled: false, key: "gift_details" },
      { key: "contact_socials" },
      { defaultEnabled: false, key: "music_effects" },
      { defaultEnabled: false, key: "extra_info" },
      {
        defaultEnabled: false,
        helper: "Blessings, child story, or christening background.",
        key: "story_message",
        label: "Blessings & Story",
      },
    ],
    required: {
      ...genericRequiredConfig,
  ...
  birthday: {
    optionalDefaults: [
      ...
      { key: "gift_details" },
      { key: "contact_socials" },
      { defaultEnabled: false, key: "secondary_event" },
      { defaultEnabled: false, key: "gallery" },
      {
        defaultEnabled: false,
        helper: "Celebrant milestone, message, or birthday story.",
        key: "story_message",
